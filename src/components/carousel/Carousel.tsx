    ...
    <section className="">
      <div className="overflow-hidden" ref={emblaRef}>
        <div className="flex items-center gap-[20px] lg:gap-[40px] mt-10">
          {slides.map((slide, i) => (
            <div className="min-w-[282px] lg:min-w-[256px] min-h-[430px] relative border" key={i}>
              <div className='absolute top-0 left-0 right-0 bottom-0'>
                <img src={slide.url} className='w-full h-full object-cover' />
              </div>
              <div className="absolute top-5 left-3 text-white max-w-[100px] font-Akkurat font-bold tracking-[-0.02em] text-[1.875rem] leading-[2.156rem]">{slide.title}</div>
