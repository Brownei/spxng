  ...
  return (
    <main>
      <div className="flex flex-col gap-[20px] lg:gap-[40px] lg:h-[500px] lg:flex-row w-full">
        <Link to="/about" className="lg:w-[65%] w-full lg:h-full h-[485px] border relative">
          ...
          <div className="absolute top-4 left-4 pr-[4rem] flex flex-col gap-3">
            <span className=" z-50 text-white font-Akkurat font-bold text-[0.687rem] leading-[0.894rem]">CREDIT MARKET</span>
            <h1 className="font-Akkurat z-20 leading-[2.587rem] text-[2.25rem] font-bold text-white">Tokenized Private Credit: A New Digital Frontier for Real World Assets</h1>
